...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet"
        href="{{ asset('assets/adminlte2418/bower_components/bootstrap/dist/css/bootstrap.min.css') }} ">
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="{{ asset('assets/adminlte2418/bower_components/font-awesome/css/font-awesome.min.css') }}">
    <!-- Ionicons -->
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <div class="login-logo">
                ...
                <p class="text-center" style="font-size: 12px;">Umroah Test</p>
